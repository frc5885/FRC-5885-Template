...
public class RobotSystem extends LoggedRobot {
  ...
  public void testInit() {
    ...
    testTab.add(
        "Arm.Up",
        new TestArmUpCommand(m_robotContainer.m_armSubsystem, m_robotContainer.m_ledSubsystem));

    testTab.add(
        "Arm.Down",
        new TestArmDownCommand(m_robotContainer.m_armSubsystem, m_robotContainer.m_ledSubsystem));

    // Wrist
    testTab.add(
        "Wrist.Aim",
        new TestWristAimCommand(
            m_robotContainer.m_wristSubsystem, m_robotContainer.m_ledSubsystem));
    ...
    testTab.add(
        ...
        new TestShooterCommand(
            m_robotContainer.m_shooterSubsystem, m_robotContainer.m_ledSubsystem));
