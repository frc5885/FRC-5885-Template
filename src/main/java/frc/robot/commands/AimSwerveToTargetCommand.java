...
public class AimSwerveToTargetCommand extends Command {
    ...
    public AimSwerveToTargetCommand(SwerveDriveSubsystem swerveDrive, 
    ...
    public void execute() {
        ...
        // apply the angular velocity to the swerve drive (it should never translate the robot, only rotate it)
