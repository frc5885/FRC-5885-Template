...
public class RobotContainer {
    ...
    private final LoggedDashboardChooser<Command> m_initialPoseChooser = new LoggedDashboardChooser<>("Starting Pose");
    ...
    private void configureBindings() {
        ...
        m_feederSubsystem.setDefaultCommand(new InstantCommand(() -> {
        }, m_feederSubsystem));
    }
