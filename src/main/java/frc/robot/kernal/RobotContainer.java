...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // new JoystickButton(m_driverController.getHID(), Button.kRightStick.value)
    //         .whileTrue(new InstantCommand(
    //                         () -> {
    //                             m_climberSubsystem.rightStickButton(true);
    //                         }))
    //         .whileFalse(new InstantCommand(
    //                         () -> {
    //                             m_climberSubsystem.rightStickButton(false);
    //                         }));
    // new JoystickButton(m_driverController.getHID(), Button.kLeftStick.value)
    //         .whileTrue(new InstantCommand(
    //                         () -> {
    //                             m_climberSubsystem.leftStickButton(true);
    //                         }))
    //         .whileFalse(new InstantCommand(
    //                         () -> {
    //                             m_climberSubsystem.leftStickButton(false);
    //                         }));
