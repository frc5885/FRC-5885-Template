...
public class WristSubsystem extends WCStaticSubsystem {
  ...
  protected List<MotorController> initMotors() {
    ...
    m_PidController = new PIDController(31.0, 2.25, 0.85);
    m_PidController.setTolerance(0.02);

    m_feedForward = new ArmFeedforward(0.1, 0, 0);
  ...
  public void periodic() {
    ...
    if (subsystemAction == SubsystemAction.POS) {
      ...
      double calc = m_feedForward.calculate(measurement, m_setPoint) - m_PidController.calculate(measurement, m_setPoint);
