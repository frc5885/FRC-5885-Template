...
public class SwerveDrive extends SubsystemBase {
  ...
  public void periodic() {
    ...
    m_rotation = m_rotation * 0.95; // Friction factor
  ...
  public void setModuleStates(SwerveModuleState[] desiredStates) {
    ...
    for (int i = 0; i != 4; i++) {
      ...
      m_modules[i].setDriveVoltage((desiredStates[i].speedMetersPerSecond / 5) * 12);
      System.out.println(
          i + " m_modulesInput[i].turnPositionRad " + m_modulesInput[i].turnPositionRad);
